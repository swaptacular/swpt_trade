...
Revision ID: eab854931bb5
Revises: 
Create Date: 2024-03-17 17:02:14.420464
...
def upgrade_solver():
    ...
    sa.Column('account_id', sa.String(), nullable=False),
    sa.Column('status', sa.SmallInteger(), nullable=False, comment="Collector account's status: 0) requested account creation; 1) created and operational; 2) disabled."),
    sa.Column('latest_status_change_at', sa.TIMESTAMP(timezone=True), nullable=False),
    sa.CheckConstraint('status >= 0 AND status <= 2'),
