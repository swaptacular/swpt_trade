...
Revision ID: 8fac77ce147a
Revises: c442e0862585
Create Date: 2024-06-13 14:28:19.044809
...
def upgrade_():
    ...
    sa.CheckConstraint('scheduled_for IS NULL OR failure_code IS NOT NULL'),
