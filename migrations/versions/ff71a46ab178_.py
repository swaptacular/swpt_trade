...
Revision ID: ff71a46ab178
Revises: 
Create Date: 2024-01-21 19:55:39.054737
...
def upgrade_solver():
    ...
    sa.Column('turn_id', sa.Integer(), nullable=False),
    sa.Column('debtor_id', sa.BigInteger(), nullable=False),
    sa.Column('debtor_info_iri', sa.String(), nullable=False),
    sa.Column('debtor_info_content_type', sa.String(), nullable=False),
    sa.Column('debtor_info_sha256', sa.LargeBinary(), nullable=False),
