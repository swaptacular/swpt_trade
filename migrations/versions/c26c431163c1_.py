...
Revision ID: c26c431163c1
Revises: 01a7c27aad49
Create Date: 2024-05-16 15:15:40.555655
...
def upgrade_():
    ...
    sa.CheckConstraint('transfer_id IS NULL AND amount >= 0 AND finalized_at IS NULL OR transfer_id IS NOT NULL AND amount != 0 AND (finalized_at IS NOT NULL OR status_code IS NULL)'),
